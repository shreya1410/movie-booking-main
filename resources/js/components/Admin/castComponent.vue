<template>
    <div>
        ...
        <div class="form-group">
            <label for="list_of_movies">List of movies</label>
            <input type="text" id="list_of_movies"
                   placeholder="Enter List Movies" class="form-control"
                   v-model="list_of_movies">
        </div>
        <div class="form-group">
        ...
        <div class="col-md-12 mt-3" v-if="casts.length>0">
            ...
            <ul class="list-group">
                <li class="list-group-item"
                    ...
                    {{cast.name}} - {{cast.bio}} - {{cast.birth_date}}  - {{cast.list_of_movies}}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                <label for="editlistofmovies">List of Movies</label>
                                <input type="text" v-model="editlistofmovies" class="form-control" id="editlistofmovies"  placeholder="Enter list of movies">
                            </div>
    ...
    methods:{
        ...
        save(){
            axios.post('save_cast',{
                ...
                list_of_movies : this.list_of_movies,
            })
                .then(response => {
                    this.name = '';
                    this.bio = '';
        ...
        editCast(id){
            axios.get('edit_cast/'+id)
                .then(response=>{
                   ...
                   this.editlistofmovies = response.data.list_of_movies;
        ...
        updateCast(){
            axios.put('update_cast',{
                ...
                name :this.editname,
                bio : this.editbio,
                list_of_movies: this.editlistofmovies
            })
                .then(response => {
                    this.fetchAll();
                } );
